          ...
          <div className="md:w-1/2">
            <div className="relative bg-white p-6 rounded-xl shadow-lg">
              ...
              <div className="flex justify-center mb-6">
                <div className="bg-primary text-white rounded-full w-10 h-10 flex items-center justify-center hover-scale">
                  <svg
              ...
              <div className="bg-gradient-to-r from-primary to-secondary text-white p-6 rounded-lg text-center hover-scale-sm">

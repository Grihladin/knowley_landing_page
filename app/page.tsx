...
import DemoSection from "./DemoSection"; // Changed from VideoSection
  ...
  return (
    <div className="flex flex-col min-h-screen">
        ...
        <div className="container mx-auto px-4 py-4">
          <div className="flex flex-col sm:flex-row items-center">
            ...
            <nav className="flex space-x-4 sm:space-x-8 mx-auto text-sm sm:text-base" aria-label="Main navigation">
              <a href="#demo" onClick={(e) => handleSmoothScroll(e, "#demo")} className="hover:text-primary" aria-label="Demo section">Demo</a> {/* Changed from #video and Video section */}
      ...
      <main className="flex-grow" id="main-content" role="main">
        <HeroSection />
        <DemoSection /> {/* Changed from VideoSection */}
        <FeaturesSection />
        <BenefitsSection />
        <TeamSection />
        <CTASection />
